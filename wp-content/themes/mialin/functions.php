...
add_shortcode( 'product_categories_list', 'woo_product_categories_list' );
function woo_product_categories_list(  ) {
 ...
 echo '<ul class="nav nav-pills nav-stacked vertical-left-menu">';
 foreach ($all_categories as $cat) {
    if($cat->category_parent == 0) {
        $category_id = $cat->term_id;       
        echo '<li><a href="'. get_term_link($cat->slug, 'product_cat') .'"><i class="fa fa-angle-right"></i> '. $cat->name .'</a></li>'; 
